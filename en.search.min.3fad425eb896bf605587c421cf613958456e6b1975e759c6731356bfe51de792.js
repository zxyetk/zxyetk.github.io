...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9227feed090d4d942239070a6a8224148fa3a6091dccd97fb8ea9d7d1808d8a9.js',function(){input.required=false;search();});}
